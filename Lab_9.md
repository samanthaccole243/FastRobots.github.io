...
For the plot below, p5_n3_t1 is plotted in blue, p5_n3_t2 is plotted in cyan. n3_n2_t1 is plotted in red, n3_n2_t2 is plotted in magenta. p5_p3_t1 is plotted in yellow. p5_p3_t2 is plotted in orange. zp3_t1 is in black, while zp3_t2 is in grey. If it is not clear from above, n stands for negative, p is for positive, and z is for sero while the names represent the location and t1 or t2 represents trial 1 or 2 for that location.
